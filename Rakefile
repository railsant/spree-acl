...
desc 'Generate documentation for the acl extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'AclExtension'
...
namespace :test do
  desc 'Functional test the acl extension.'
  ...
  desc 'Unit test the acl extension.'
